<script lang="ts">
	...
	import { FolderTree, Sparkles, Award, ArrowRight, BookOpen, Flame, Search, CheckCircle2, Layers } from 'lucide-svelte';
	...
	<header class="border-b border-border pb-5">
		<div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
			<div>
				...
				<h1 class="font-display mt-2 text-3xl font-bold tracking-tight">Syllabus Directory & Topic Tree</h1>
